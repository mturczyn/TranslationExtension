...
namespace AddTranslation.TranslationResourcesManagement
{
    ...
    public class TranslationResourcesManager
    {
        ...
        public List<Translation> GetAllSimilairTranslations(string textToFind)
        {
            ...
            List<Translation> orderedTranslations = new List<Translation>();

            if (string.IsNullOrEmpty(textToFind))
                orderedTranslations = translations;
            else
                orderedTranslations = translations.OrderBy(tr => ClosestStringMatch.GetDistance(textToFind, tr.PolishText)).ToList();
